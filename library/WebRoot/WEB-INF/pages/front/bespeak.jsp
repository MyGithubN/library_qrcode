...
<nav class="navbar navbar-default navbar-fixed-head">
		<div class="col-xs-6">
			<div class="vertical-center">
                ...
                <s:else>
                	<a class="navbar-brand" href="<%=path%>/bespeak_s_bespeak" >未完成</a>
                </s:else>
			</div>
		</div>
		<div class="col-xs-6">
			<div class="vertical-center">
                ...
                <s:else>
                	<a class="navbar-brand" href="<%=path%>/bespeak_s_bespeak?tab=0" >已完成</a>
                </s:else>
			</div>
		</div>
</nav>
        ...
        <tbody>
	        <s:iterator value="#request.pageBean.data" var="bespeak">
		        <tr>
		            ...
		            <s:if test="#request.tab == 1">
		            <td>
		                <a href="<%=path %>/bespeak_delete?yid=<s:property value="#bespeak.id" />&tab=1"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a><br/>
		            </td>
		            </s:if>
		        </tr>
		        <tr>
